class WykopHelper {
    ...
    static prepareEntryBody(body) {
        ...
        let parts = body.split(splitter).map((part) => WykopHelper.escapeEntryBody(part));
        let length = 0;
